...
<head>
    ...
    <style>
        ...
        /* Membuat teks judul lebih menonjol */
        h1,
        h2,
        h3,
        .font-bold {
            letter-spacing: -0.025em;
            /* Memberi kesan modern dan padat */
        }
...
<body class="bg-gray-50 text-gray-800 font-sans antialiased">
    ...
    <nav class="bg-blue-800 text-white h-16 flex items-center px-6 shadow-md fixed top-0 left-0 right-0 z-50">
        <div class="flex items-center gap-3 w-64">
            ...
            <span class="font-bold text-xl tracking-tight">XKargo</span>
        </div>
    ...
    <div class="flex pt-16">
        ...
        <aside class="w-64 bg-blue-900 text-white min-h-screen fixed top-16 left-0 bottom-0 overflow-y-auto">
            <nav class="p-4 space-y-1">
                {{-- Grup: Data Master --}}
                <p class="text-blue-400 text-xs font-semibold uppercase tracking-wider px-3 pt-3 pb-1">
                    Data Master
                </p>
        ...
        <main class="ml-64 flex-1 @yield('fullscreen', '') min-h-screen">
            @hasSection('fullscreen')
                {{-- Mode fullscreen: tidak ada padding, iFrame fill penuh --}}
                @yield('content')
            @else
                <div class="p-6">
                    @if (session('success'))
                    ...
                    text-emerald-800 text-sm font-medium px-5 py-3.5 rounded-xl">
                            <svg class="h-4 w-4 flex-shrink-0 text-emerald-600" fill="none" viewBox="0 0 24 24"
                    ...
                    text-red-800 text-sm font-medium px-5 py-3.5 rounded-xl">
                            <svg class="h-4 w-4 flex-shrink-0 text-red-500" fill="none" viewBox="0 0 24 24"
    ...
    @push('scripts')
        <script>
            // Sembunyikan loader saat iFrame selesai loading
